                  ...
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
                      <p id="hyp_knowmore">
                       ...
                       <c:set var = "string2" value = "${fn:replace(string1, '.pdf', '')}" />
                       
                   
                          
         <a class="download-resource" target="_blank" href="${pageContext.request.contextPath}/resources/infograph/${string2}">Know More</a>  </p>  
