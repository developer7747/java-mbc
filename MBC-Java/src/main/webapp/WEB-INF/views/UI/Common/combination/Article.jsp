...
<li>
<a style="color:white" target="_blank" href="${Article.customtitle}">${Article.customtitle}</a></li>
<br><li><a style="color:white" target="_blank" href="${Article.customtitle}">${Article.customtitle}</a></li>
<br><li><a style="color:white" target="_blank" href="${Article.customtitle}">${Article.customtitle}</a></li><br></div>
                            
                         
                      ${Article.metaKeyword}     </c:forEach> 
                            </div>
                        </div>
                    </div>
