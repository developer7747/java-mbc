...
<div class="side-content side-content2" id="side-content-3"  style="height: 70px; width: 400px; top: 400px; right: 0px;  padding: 16px;"><%--top: 278px--%>
    <a href="javascript:void(0)" class="closeme"style="top: -4px; position: relative; background: white; color: black; right: 0px; border:1px solid;">X</a>


     <ul class="inline">
        <li id="l1" style="width: 80%; background:#8DC153;margin:0px 0px 0px 27px">

    </ul>
</div>
<div class="side-content side-content2" id="side-content-4"  style="height: 70px; width: 550px; top: 400px; right: 0px;  padding: 16px;"><%--top: 278px--%>
    <a href="javascript:void(0)" class="closeme"style="top: -4px; position: relative; background: white; color: black; right: 0px; border:1px solid;">X</a>


     <ul class="inline">
        <li style="width: 86%; background:#8DC153"><%--<a href="https://plus.google.com/u/0/+Medicalbillersandcoders1" target="_blank" title="Google Plus Profile for Jacob Thomas">
            <img src=""images/social_google_plus.jpg" alt="MBC-Google+" title="MBC-Google+"--%>
          
          
          <a href="http://www.medicalbillersandcoders.com/blog" target=_blank runat="server" Class="btn btn-success" style="background: rgb(0, 177, 186) none repeat scroll 0% 0%;color:White;
border: 1px solid rgb(0, 168, 177);
width: 24%;
padding: 0px ;
margin: 0px 5px;" >MBC Blog</a>
          
          


  <a id="A1" href="http://www.medicalbillersandcoders.com/dme-billing-services-blog" target=_blank runat="server" Class="btn btn-success" style="background: rgb(0, 177, 186) none repeat scroll 0% 0% ;color:White;
border: 1px solid rgb(0, 168, 177);
width: 24%;
padding: 0px;
margin: 0px 24px;">Dme Blog</a>

<a id="A2" href="http://www.medicalbillersandcoders.com/pharmacy-billing-services-blog" target=_blank runat="server" Class="btn btn-success" style="background: rgb(0, 177, 186) none repeat scroll 0% 0%;color:White;
border: 1px solid rgb(0, 168, 177);
width: 36%;
padding: 0px ;
margin: 0px 0px;" >Pharmacy Blog</a>
          


</li>  <%--OnClick="btn_dme_Click"--%>
    </ul>
</div>
