...
<div class="row">
                            ...
                            <div class="col-xs-9">
                              <a href="articles.aspx" style="color:white"> <h3 style="color:" #ffffff"="">Articlse </h3></a>
...
<li><a style="color:white" target="_blank" href="${Speciality.name}"> ${Speciality.name}</a></li>
<br><li><a style="color:white" target="_blank" href="${Speciality.name}">${Speciality.name}</a></li>
<br><li><a style="color:white" target="_blank" href="${Speciality.name}">${Speciality.name}</a></li><br>
</div>
                   </c:forEach>         </div>
                        </div>
