...
<div class="container">
 ...
 <!-- Main about us content start-->
    <div class="container">
        ...
        <jsp:include page="/WEB-INF/views/UI/Common/combination/CommonBanner.jsp" />
...
<%--             <c:out value="${message}" /> --%>
 ...
 <jsp:include page="/WEB-INF/views/UI/Common/combination/Left-Section.jsp" />
 
 
 
  <div class="col-sm-5 right-sidebar">
<%--   <jsp:include page="/WEB-INF/views/UI/Common/combination/blog-links.jsp" /> --%>
