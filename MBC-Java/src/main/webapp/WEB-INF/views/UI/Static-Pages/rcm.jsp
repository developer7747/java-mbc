...
<img src="http://www.medicalbillersandcoders.com/upload/Revenue-cycle-management.png">
        </div>

<div class=" text-center">
            <div class="container">

                <h2 class="text-green padding-bottom-20"><b>Our billers provide services across:</b></h2>
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="services-boxes">
                            <p class="prcm"><b><strong>Accounts Receivable</strong></b></p>
                            <p class="text-left">
                                Revenue waiting to be collected is revenue lost!
...
Our billers believe that accuracy of the claim and the time spent on retrieving the payment are key points in optimized revenue collections. ...
                    ...
                    <div class="col-sm-12 text-left padding-bottom-40">
                        ...
                        <p>The skill to provide these services has come with years of hands on experience and dealing with government and commercial payers on a daily basis. They also leverage their existing relationships to get your practice paid faster.</p>

                        <h4 class="padding-top-20"><b>The local attention and customer satisfaction will truly give you the level of service you are looking for.....</b></h4>
                    </div>
                </div>
            </div>
