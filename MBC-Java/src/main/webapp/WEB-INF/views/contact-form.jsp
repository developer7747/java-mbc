...
<body>
    <div align="center">
        <form:form action="contact-us"  modelAttribute="user" method="post" commandName="userForm">
...
<!--                          <label for="cname">Name (required, at least 2 characters)</label> -->
                         <td>    <form:input id="cname" name="name" minlength="2" type="text" path="Contact_Name"  required="" aria-required="true" class="valid" aria-invalid="false"/>
...
<%--                     <td><form:input id="cname" name="name" minlength="2" type="text" required cssClass="error" path="Contact_Name" /></td> --%>
                ...
                <label for="cemail">E-Mail (required)</label>
                    <td>E-mail:</td>
                    <td><form:input  id="cemail" type="email" name="email" cssClass="error"  path="Email_ID" /></td>
                 ...
                 <tr>
                  ...
                  <tr>
 <td colspan="2" align="center"><div class="g-recaptcha" data-sitekey="6LeEDSUTAAAAAHM4ISRO_ItbCWPsc4XqZcUujZmI"></div></td>
                </tr>
                <tr>
